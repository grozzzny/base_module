...
class AController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            [
                ...
                'model' => $this->module->getModel(Yii::$app->request->get('slug'))
            ],
        ];
    }
    ...
    {
        $current_model = $this->module->getModel($slug);
        ...
        return $this->render('@grozzzny/base_module/views/a/index', [
            'data' => $data,
    ...
    public function actionCreate($slug)
    {
        ...
        if ($current_model->load(Yii::$app->request->post())) {
            ...
            return $this->render('@grozzzny/base_module/views/a/create', [
                'current_model' => $current_model
            ]);
        }
    }
    ...
    public function actionEdit($slug, $id)
    {
        ...
        if ($current_model->load(Yii::$app->request->post())) {
            ...
            return $this->render('@grozzzny/base_module/views/a/edit', [
                'current_model' => $current_model
            ]);
        }
    }
    ...
    public function actionPhotos($slug, $id)
    {
        ...
        return $this->render('@grozzzny/base_module/views/a/photos', [
            'current_model' => $current_model,
        ]);
    }
...
//    {
//        $current_model = BaseModel::getModel($slug);
//
//        $current_model = $current_model::findOne($id);
//
//        if(!($current_model)){
